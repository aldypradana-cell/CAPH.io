    ...
    return (
        <div className="-mx-6 px-6 flex gap-4 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide md:mx-0 md:px-0 md:grid md:grid-cols-3 md:gap-6 md:overflow-visible md:pb-0">
            ...
            <div className="min-w-[220px] sm:min-w-[280px] snap-center md:min-w-0 glass-premium p-4 sm:p-5 md:p-7 rounded-[2.5rem] hover:scale-[1.02] active:scale-[0.98] transition-all duration-500 group relative overflow-hidden animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                <div className="absolute inset-0 opacity-20 dark:opacity-40 -z-10">
                    <div className="absolute inset-0 bg-[#0E3D42]/10 blur-3xl" />
                </div>
                <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                        <div className="p-3 bg-[#0E3D42]/10 text-[#0E3D42] dark:text-[#C5A059] rounded-2xl backdrop-blur-md shadow-inner ring-1 ring-[#C5A059]/10">
                            <WalletIcon weight="duotone" className="w-7 h-7" />
                        </div>
                        <span className="flex items-center text-[10px] font-black px-2.5 py-1.5 rounded-xl bg-[#0E3D42]/5 dark:bg-[#0E3D42]/20 text-[#0E3D42] dark:text-[#C5A059] backdrop-blur-md shadow-sm ring-1 ring-[#C5A059]/10 italic tracking-tighter">
                    ...
                    <p className="text-2xl sm:text-3xl font-black text-[#0E3D42] dark:text-[#EDEDD6] tracking-tighter break-words drop-shadow-sm">{formatIDR(stats.balance)}</p>
                </div>
            </div>
            ...
            <div className="min-w-[220px] sm:min-w-[280px] snap-center md:min-w-0 glass-premium p-4 sm:p-5 md:p-7 rounded-[2.5rem] hover:scale-[1.02] active:scale-[0.98] transition-all duration-500 group relative overflow-hidden animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                ...
                <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                        <div className="p-3 bg-[#0E3D42]/10 text-[#0E3D42] dark:text-[#5EEAD4] rounded-2xl backdrop-blur-md shadow-inner ring-1 ring-[#C5A059]/10">
                            <TrendingUp weight="duotone" className="w-7 h-7" />
                        </div>
                        <span className="flex items-center text-[10px] font-black px-2.5 py-1.5 rounded-xl bg-[#0E3D42]/5 dark:bg-[#0E3D42]/20 text-[#0E3D42] dark:text-teal-400 backdrop-blur-md shadow-sm ring-1 ring-[#C5A059]/10 italic tracking-tighter">
                    ...
                    <p className="text-2xl sm:text-3xl font-black text-[#0E3D42] dark:text-[#EDEDD6] tracking-tighter break-words drop-shadow-sm">{formatIDR(stats.totalIncome)}</p>
                </div>
            </div>
            ...
            <div className="min-w-[220px] sm:min-w-[280px] snap-center md:min-w-0 glass-premium p-4 sm:p-5 md:p-7 rounded-[2.5rem] hover:scale-[1.02] active:scale-[0.98] transition-all duration-500 group relative overflow-hidden animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                ...
                <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                        <div className="p-3 bg-[#9F1239]/10 text-[#9F1239] dark:text-rose-400 rounded-2xl backdrop-blur-md shadow-inner ring-1 ring-white/10">
                            <TrendingDown weight="duotone" className="w-7 h-7" />
                        </div>
                        <span className="flex items-center text-[10px] font-black px-2.5 py-1.5 rounded-xl bg-[#9F1239]/5 text-[#9F1239] dark:bg-[#9F1239]/20 backdrop-blur-md shadow-sm ring-1 ring-white/10 italic tracking-tighter">
                    ...
                    <p className="text-2xl sm:text-3xl font-black text-[#0E3D42] dark:text-[#EDEDD6] tracking-tighter break-words drop-shadow-sm">{formatIDR(stats.totalExpense)}</p>
                </div>
            </div>
        </div>
    );
