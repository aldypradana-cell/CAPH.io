                ...
                <div className="w-full max-w-[420px] relative z-10 flex flex-col items-center">
                    ...
                    <div className="w-full bg-slate-900/60 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] relative overflow-hidden p-8">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-slate-400 text-sm mt-2 font-medium">Isi data di bawah untuk memulai perjalanan finansial Anda.</p>
                        </div>

                        <form onSubmit={submit} className="space-y-4">
                            <div>
                                <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 ml-1 cursor-pointer" htmlFor="name">Nama Lengkap</label>
                                <input
                                    id="name"
                                    type="text"
                                    value={data.name}
                                    ...
                                    className="w-full px-4 py-3 bg-slate-950/50 border border-slate-700/50 rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 focus:bg-slate-900/80 transition-all font-medium shadow-inner"
                                />
                                {errors.name && <p className="mt-1.5 text-xs font-medium text-red-400 ml-1">{errors.name}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full px-4 py-3 pr-12 bg-slate-950/50 border border-slate-700/50 rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 focus:bg-slate-900/80 transition-all font-medium shadow-inner tracking-widest"
                                    />
                            ...
                            <div>
                                <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 ml-1 cursor-pointer" htmlFor="password_confirmation">Konfirmasi Kata Sandi</label>
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-slate-950/50 border border-slate-700/50 rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 focus:bg-slate-900/80 transition-all font-medium shadow-inner tracking-widest"
                                />
                                {errors.password_confirmation && <p className="mt-1.5 text-xs font-medium text-red-400 ml-1">{errors.password_confirmation}</p>}
                            </div>
                            ...
                            >
                                ...
                                <span className="relative z-10">{processing ? 'Mendaftar...' : 'Daftar Sekarang →'}</span>
                            </button>
                        </form>
                        ...
                        <div className="mt-8 text-center pt-6 border-t border-slate-700/50">
                            <p className="text-sm font-medium text-slate-400">
                                Sudah punya akun?{' '}
                                <Link href={route('login')} className="font-bold text-white hover:text-indigo-300 transition-colors">
                                    Masuk di sini
                                </Link>
                            </p>
                        </div>
